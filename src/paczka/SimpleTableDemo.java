...
public class SimpleTableDemo extends JPanel {
    ...
    private static void createAndShowGUI() throws IOException {
        ...
        CsvFileReader csvReader = new CsvFileReader("Testowy.csv");
...
//        DataProcessor.sortArrayByColumn(dane1, 3);


        //Create and set up the content pane.
        SimpleTableDemo newContentPane = new SimpleTableDemo(headers, data);
